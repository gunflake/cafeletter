<%@ Page Title="" Language="C#" MasterPageFile="~/SidebarMember.master" AutoEventWireup="true" CodeBehind="BuyDetail.aspx.cs" Inherits="cafeLetter.Member.BuyDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SidebarMemberBody" runat="server">
            ...
            <asp:Button ID="CancelBuyItemBtn" runat="server" class="btn btn-primary" Text="구매취소"  OnClick="CancelBuyItemBtn_Click"></asp:Button>
