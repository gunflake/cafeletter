    ...
    public partial class NoticeView : System.Web.UI.Page
    {
        ...
        private void PostView()
        {
            ...
            try
            {
                ...
                if (pl_intRetVal != 0)
                {
                    module.PrintAlert("공지사항 상세보기 조회에 실패했습니다.", "/Service/NoticeList.aspx");
                    return;
                }
        ...
        private void CommentRegister(string strCommentBody)
        {
            ...
            try
            {
                ...
                if (pl_intRetVal == 0)
                {
                    module.PrintAlert("댓글이 등록되었습니다", "/Service/NoticeView.aspx?BoardNo=" + intBoardNo);
                    return;
                }
                else
                {
                    module.PrintAlert("입력 정보를 다시 확인해주세요", "/Service/NoticeView.aspx?BoardNo=" + intBoardNo);
                    return;
                }
            }
            catch
        ...
        protected void BoardModify_Click(object sender, EventArgs e)
        {
            ...
            {
                module.moveURL("/Admin/AdminNoticeModify.aspx?BoardNo=" + intBoardNo);
                return;
            }
        ...
        private void NoticeDeleteDB()
        {
            ...
            try
            {
                ...
                if (pl_intRetVal == 0)
                {
                    module.PrintAlert("공지사항을 삭제했습니다.", "/Admin/AdminNoticeList.aspx");
                }
                else
                {
        ...
        private void CommentUpdate(string strCmtContent, int intCommentNo)
        {
            ...
            try
            {
                ...
                if (pl_intRetVal == 0)
                {
                    module.moveURL("/Service/NoticeView.aspx?BoardNo=" + intBoardNo);
                    return;
                }
                else
                {
                    module.PrintAlert(pl_strOutputMsg, "/Service/NoticeView.aspx?BoardNo=" + intBoardNo);
                    return;
                }
            }
            catch
        ...
        private void CommentDeleteDB(int intCommentNo)
        {
            ...
            try
            {
                ...
                if (pl_intRetVal == 0)
                {
                    module.PrintAlert("댓글이 삭제되었습니다.", "/Service/NoticeView.aspx?BoardNo=" + intBoardNo);
                    return;
                }
                else
                {
