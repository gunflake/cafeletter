<%@ Page Language="C#" MasterPageFile="~/SidebarBoard.master" AutoEventWireup="true" CodeBehind="BoardView.aspx.cs" Inherits="cafeLetter.BoardView" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SidebarBoardBody" runat="server">
    ...
    <div class="col-sm-9 col-md-10">
        ...
        <div class="row">
            <div class="col-md-9">
                <p>등록날짜: <%=strPostDate %></p>
                <hr />
            </div>
            <div class="col-md-3" style="text-align: right">
                <p>작성자 : <%=strPostWriter %> </p>
                <hr />
            </div>
        </div>
        ...
        <div class="row" style="margin-left: 0px; margin-right: 0px;">
            <asp:Button ID="BoardModify" runat="server" class="btn btn-primary" Text="수정" OnClientClick="return confirmPostUpdate();" OnClick="BoardModify_Click"></asp:Button>
        ...
        <div class="row" style="margin-left: 0px; margin-right: 0px; margin-top: 15px;">
            <h5>댓글</h5>
            <asp:TextBox runat="server" ID="CommentBody" MaxLength="400" TextMode="MultiLine" Rows="5" class="form-control"  placeholder="댓글을 입력하세요" onkeyup="commentCheck(this)"/>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <asp:Button ID="CommentUpdate" Visible="false" OnClientClick="return validationCommentUpdateBtn();" runat="server" class="btn btn-primary" Text="수정" Style="top: 10px;" OnClick="CommentUpdate_Click"></asp:Button>
                                    </div>
                                </div>
