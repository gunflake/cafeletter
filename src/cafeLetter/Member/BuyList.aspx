<%@ Page Title="" Language="C#" MasterPageFile="~/SidebarMember.master" AutoEventWireup="true" CodeBehind="BuyList.aspx.cs" Inherits="cafeLetter.Member.BuyList" %>
                ...
                <asp:Repeater ID="MyCashList" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="text-align:center"><asp:HyperLink  runat="server" Text='<%# Eval("PURCHASEINFO") %>' NavigateUrl='<%# String.Format("/Member/BuyDetail.aspx?strPurchaseNo={0}",Eval("PURCHASENO")) %>'></asp:HyperLink></td>
