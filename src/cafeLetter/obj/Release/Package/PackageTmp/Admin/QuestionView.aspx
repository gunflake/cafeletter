<%@ Page Title="" Language="C#" MasterPageFile="~/SidebarAdmin.master" AutoEventWireup="true" CodeBehind="QuestionView.aspx.cs" Inherits="cafeLetter.Admin.QuestionView" %>
                    ...
                    <div class="panel panel-default" style="width: 97%; margin: 0 auto; margin-bottom: 10px;">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <span class="data D"><%# Eval("USERID") %> &nbsp;  ☆<%# Eval("COMMENTLIKE") %> &nbsp; <%# Eval("COMMENTDATE") %> </span>
