...
namespace cafeLetter.Member
{
    public partial class BuyDetail : System.Web.UI.Page
    {
        ...
        protected void Page_PreInit(object sender, EventArgs e)
        {
            ...
            {
                objModule.PrintAlert("잘못된 접근입니다", "/Member/BuyList.aspx");
                return;
            }
            ...
            {
                objModule.saveSession("beforeURL", "/Member/BuyDetail.aspx?strPurchaseNo="+ strPurchaseNo);
        ...
        private void MyBuyListDB()
        {
            ...
            try
            {
                ...
                if(pl_intRecordCnt == 1)
                {
                    ...
                    CancelBuyItemBtn.Visible = !strCnlState.Equals("Y");
                }
                else
                {
