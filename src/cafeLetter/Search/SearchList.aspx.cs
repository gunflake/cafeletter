    ...
    public partial class SearchList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.Params["searchType"] != null && Request.Params["searchQuery"] != null)
            {
                ...
                else if (Request.Params["searchType"].Equals("3"))
                {
                    strSearchTag = Request.Params["searchQuery"];
                }
        ...
        protected void PostList(string strSearchID, string strSearchTitle, string strSearchTag, int intOrderFlag, int intPageNo, int intPageSize)
        {
            ...
            try
            {
                ...
                pl_objDas.AddParam("@pi_strSearchTag", DBType.adVarChar, strSearchTag, 100, ParameterDirection.Input);
                ...
                pl_objDas.SetQuery("dbo.UP_SEARCHBOARD_NT_LST");
                ...
                string hrefURL = "/Search/SearchList.aspx";
        ...
        protected void SearchButton_Click(object sender, EventArgs e)
        {
            ...
            intPageNo = 1;
            module.moveURL("/Search/SearchList.aspx?PageNo=" + intPageNo + "&PageSize=" + intPageSize + "&OrderFlag=" + intOrderFlag + "&searchType=" + pl_intSearchType + "&searchQuery=" + pl_strSearchQuery);
        }
        ...
        protected void Page10_Click(object sender, EventArgs e)
        {
            intPageSize = 10;
            intPageNo = 1;
            module.moveURL("/Search/SearchList.aspx?PageNo=" + intPageNo + "&PageSize=" + intPageSize + "&OrderFlag=" + intOrderFlag);
        }
