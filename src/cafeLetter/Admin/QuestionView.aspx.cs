    ...
    public partial class QuestionView : System.Web.UI.Page
    {
        ...
        private void PostView()
        {
            ...
            try
            {
                ...
                if (pl_intRetVal != 0)
                {
                    module.PrintAlert("문의사항 상세보기 조회에 실패했습니다.", "/Admin/QuestionList.aspx");
                    return;
                }
        ...
        private void CommentRegister(string strCommentBody)
        {
            ...
            try
            {
                ...
                if (pl_intRetVal == 0)
                {
                    module.PrintAlert("댓글이 등록되었습니다", "/Admin/QuestionView.aspx?BoardNo=" + intBoardNo);
                    return;
                }
                else
                {
                    module.PrintAlert("입력 정보를 다시 확인해주세요", "/Admin/QuestionView.aspx?BoardNo=" + intBoardNo);
                    return;
                }
            }
            catch
        ...
        private void NoticeDeleteDB()
        {
            ...
            try
            {
                ...
                if (pl_intRetVal == 0)
                {
                    module.PrintAlert("문의사항을 삭제했습니다.", "/Admin/QuestionList.aspx");
                }
                else
                {
                    module.PrintAlert(pl_strOutputMsg, "/Admin/QuestionList.aspx");
                }
            }
            catch
            {
        ...
        private void CommentUpdate(string strCmtContent, int intCommentNo)
        {
            ...
            try
            {
                ...
                if (pl_intRetVal == 0)
                {
                    module.moveURL("/Admin/QuestionView.aspx?BoardNo=" + intBoardNo);
                    return;
                }
                else
                {
                    module.PrintAlert(pl_strOutputMsg, "/Admin/QuestionView.aspx?BoardNo=" + intBoardNo);
                    return;
                }
            }
            catch
        ...
        private void CommentDeleteDB(int intCommentNo)
        {
            ...
            try
            {
                ...
                if (pl_intRetVal == 0)
                {
                    module.PrintAlert("댓글이 삭제되었습니다.", "/Admin/QuestionView.aspx?BoardNo=" + intBoardNo);
                    return;
                }
                else
                {
