...
{
    public partial class AdminNoticeView : System.Web.UI.Page
    {
        ...
        private void PostView()
        {
            ...
            try
            {
                ...
                if (pl_intRetVal != 0)
                {
                    module.PrintAlert("공지사항 상세보기 조회에 실패했습니다.", "/Admin/AdminNoticeList.aspx");
                    return;
                }
       ...
       //댓글 등록 DB
        private void CommentRegister(string strCommentBody)
        {
            ...
            try
            {
                ...
                if (pl_intRetVal == 0)
                {
                    module.PrintAlert("댓글이 등록되었습니다", "/Admin/AdminNoticeView.aspx?BoardNo=" + intBoardNo);
                    return;
                }
                else
                {
                    module.PrintAlert("입력 정보를 다시 확인해주세요", "/Admin/AdminNoticeView.aspx?BoardNo=" + intBoardNo);
                    return;
                }
            }
            catch
        ...
        private void CommentUpdate(string strCmtContent, int intCommentNo)
        {
            ...
            try
            {
                ...
                if (pl_intRetVal == 0)
                {
                    module.moveURL("/Admin/AdminNoticeView.aspx?BoardNo=" + intBoardNo);
                    return;
                }
                else
                {
        ...
        private void CommentDeleteDB(int intCommentNo)
        {
            ...
            try
            {
                ...
                if (pl_intRetVal == 0)
                {
                    module.PrintAlert("댓글이 삭제되었습니다.", "/Admin/AdminNoticeView.aspx?BoardNo=" + intBoardNo);
                    return;
                }
                else
                {
