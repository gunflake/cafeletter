                ...
                <asp:Repeater ID="UserListView" runat="server">
                    ...
                    <ItemTemplate>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center"><%# Eval("LASTDATE").ToString().Substring(0, 10) %></td>
                            ...
                            <asp:HyperLink ID="HyperLink1" Visible='<%# strUserRank.Equals("마스터")  ? true : false %>' runat="server" Text='추가' NavigateUrl='<%# String.Format("/Admin/AdminAdd.aspx?UserID={0}&UserName={1}",Eval("USERID"), Eval("USERNAME")) %>'></asp:HyperLink></td>
                        </tr>
                            </tbody>
                    </ItemTemplate>
                    <FooterTemplate>
