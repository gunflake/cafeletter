    ...
    <div class="col-sm-9 col-md-10">
            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr class="table-active">
                        ...
                        <td> 
                            <asp:RadioButton GroupName="Charge" ID="Cash5000" runat="server" Text="5000원"  />
                            <asp:RadioButton GroupName="Charge" ID="Cash10000" runat="server" Text="10000원"  />
                            <asp:RadioButton GroupName="Charge" ID="Cash20000" runat="server" Text="20000원"  />
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div>
            <div class="row" style="width: 65%;">
                <asp:Button runat="server" ID="cashBtn" Text="충전" class="btn btn-primary" OnClick="cashBtn_Click"/>
            </div>
        </div>
    </div>
